...
class Button:
    ...
    def tick(self, delta):
        s = 0
        symbol = self.font_icon.render(self.text[0], True, colors.BACKGROUND)
        text = self.font.render(self.text[1], True, colors.BACKGROUND)
        ...
        pygame.draw.ellipse(self.screen, colors.ACCENT, (self.position[0], self.position[1], Button.CIRCLE[0], Button.CIRCLE[1]))
        pygame.draw.ellipse(self.screen, colors.ACCENT, (self.position[0]+s, self.position[1], Button.CIRCLE[0], Button.CIRCLE[1]))
        pygame.draw.rect(self.screen, colors.ACCENT, (self.position[0]+Button.CIRCLE[0]/2, self.position[1], s, Button.CIRCLE[1]))
